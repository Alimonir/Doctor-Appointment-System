<x-layout>
    ...
    <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl lg:max-w-4xl">
          <img class="mx-auto h-12" src="{{ asset('storage/logo.jpg') }}" alt="logo">
          <figure class="mt-10">
            <blockquote class="text-center text-xl/8 font-semibold text-gray-900 sm:text-2xl/9">
              <p>“Our Doctor Appointment System simplifies the process of scheduling appointments with healthcare professionals. It provides a user-friendly interface for patients to book, reschedule, or cancel appointments, and for doctors to manage their schedules efficiently.”</p>
            </blockquote>
            <figcaption class="mt-10">
              ...
              <div class="mt-4 flex items-center justify-center space-x-3 text-base">
                ...
                <div class="text-gray-600">Online Clinic</div>
              </div>
            </figcaption>
          </figure>
        </div>
